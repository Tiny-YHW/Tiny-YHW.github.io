...
![172-algPN-11.gif](https://a1024.synology.me/images/blog/2023/172-algPN-11.gif)

1. 选择需要添加引脚信息的引脚号
2. 选择引脚类型
3. 选择引脚与焊盘连接的图形

![172-algPN-12.gif](https://a1024.synology.me/images/blog/2023/172-algPN-12.gif)

完成后封装汇总将显示定义的引脚信息图形，如果位置有偏差可以使用offsets将其放到正确的位置

![172-algPN-13.gif](https://a1024.synology.me/images/blog/2023/172-algPN-13.gif)
![172-algPN-14.gif](https://a1024.synology.me/images/blog/2023/172-algPN-14.gif)

定义引脚信息完成后*Assign Pin Leads*将被关闭，对应的图形将在封装中显示，对应的层为*Package Geometry/Component_Lead*

![172-algPN-15.gif](https://a1024.synology.me/images/blog/2023/172-algPN-15.gif)
...
![172-algPN-16.gif](https://a1024.synology.me/images/blog/2023/172-algPN-16.gif)
![172-algPN-17.gif](https://a1024.synology.me/images/blog/2023/172-algPN-17.gif)
...
![172-algPN-24.gif](https://a1024.synology.me/images/blog/2023/172-algPN-24.gif)

当选择Table方式时，会弹出一个*Edit RTP Reference Layers for Design*的对话框，用于对指定层定义参考层

![172-algPN-25.gif](https://a1024.synology.me/images/blog/2023/172-algPN-25.gif)
![172-algPN-26.gif](https://a1024.synology.me/images/blog/2023/172-algPN-26.gif)
...
![172-algPN-27.gif](https://a1024.synology.me/images/blog/2023/172-algPN-27.gif)
...
![172-algPN-28.gif](https://a1024.synology.me/images/blog/2023/172-algPN-28.gif)
...
![172-algPN-31.gif](https://a1024.synology.me/images/blog/2023/172-algPN-31.gif)
...
![172-algPN-32.gif](https://a1024.synology.me/images/blog/2023/172-algPN-32.gif)

## Component Group Move with DFA Feedback 带DFA反馈的多元器件移动

QIR7之前只移动单器件时可以带DFA反馈，此版本增强了此功能，可以通过多种方法选择多个组件，并在器件移动器件实时反馈DFA间距问题

![172-algPN-33.gif](https://a1024.synology.me/images/blog/2023/172-algPN-33.gif)
...
![172-algPN-34.gif](https://a1024.synology.me/images/blog/2023/172-algPN-34.gif)
![172-algPN-35.gif](https://a1024.synology.me/images/blog/2023/172-algPN-35.gif)

### Reverse Cutting Plane 反向切割

在使用*Cutting Plane*功能时，如果显示的可是区域是反向的，可以通过*Reverse Cutting Plane*切换切割的一侧或另一侧

![172-algPN-36.gif](https://a1024.synology.me/images/blog/2023/172-algPN-36.gif)
![172-algPN-37.gif](https://a1024.synology.me/images/blog/2023/172-algPN-37.gif)
...
![172-algPN-38.gif](https://a1024.synology.me/images/blog/2023/172-algPN-38.gif)
...
![172-algPN-39.gif](https://a1024.synology.me/images/blog/2023/172-algPN-39.gif)

### Negative Space 负空间

将实际板中的空洞部分切割掉，如孔或铣切区或板外的丝印，这样3D更接近现实

![172-algPN-40.gif](https://a1024.synology.me/images/blog/2023/172-algPN-40.gif)
![172-algPN-41.gif](https://a1024.synology.me/images/blog/2023/172-algPN-41.gif)

### Layer Transparency Setting 图层透明度设置

颜色主题中各层可以使用单独的滑块在透明（0%）和不透明（100%）之间的任何位置设置可见性。

![172-algPN-42.gif](https://a1024.synology.me/images/blog/2023/172-algPN-42.gif)
![172-algPN-43.gif](https://a1024.synology.me/images/blog/2023/172-algPN-43.gif)

### Measure Closest Distance 测量最近距离

增加一个新的菜单命令*Measure Closest Distance*，使用此命令可以显示选择物体的最小距离

![172-algPN-44.gif](https://a1024.synology.me/images/blog/2023/172-algPN-44.gif)
![172-algPN-45.gif](https://a1024.synology.me/images/blog/2023/172-algPN-45.gif)
...
![172-algPN-46.gif](https://a1024.synology.me/images/blog/2023/172-algPN-46.gif)

### Vision Options 视觉选项

- XNets: 忽略Xnet器件的飞线并直接显示Xnet的两端的互联飞线，这样会减少混乱，因为一般Xnet器件可随意调整位置不会影响线序

![172-algPN-47.gif](https://a1024.synology.me/images/blog/2023/172-algPN-47.gif)

- Ratsnest Timing:对于设置了等长但net组，飞线将显示不同的颜色以显示线长差值

![172-algPN-48.gif](https://a1024.synology.me/images/blog/2023/172-algPN-48.gif)

- Associated Comp: 需要在原理图中指定的Associated Components，并仅限于旁路电容，此类器件在移动时会显示一个圆，引导将器件放置到其关联的器件附近

![172-algPN-49.gif](https://a1024.synology.me/images/blog/2023/172-algPN-49.gif)
