...
| `_layouts` | 这些是包装文章的模板。在[YAML Front Matter](https://link.juejin.cn/?target=https%3A%2F%2Fjekyllrb.com%2Fdocs%2Ffrontmatter%2F "https://jekyllrb.com/docs/frontmatter/")中逐层选择布局，这将在下一节中介绍。 |
